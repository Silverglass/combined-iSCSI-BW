 ...
 */
#define SCSI_MAX_PHYS_SEGMENTS	128
...
static inline uint32_t scsi_to_u32(uint8_t *ptr)
{
...
struct scsi_device *scsi_device_lookup_by_target(struct Scsi_Host *shost, struct scsi_target *starget, uint32_t lun);
#endif /* _SCSI_SCSI_H */
